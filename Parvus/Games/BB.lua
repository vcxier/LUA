...
local Loaded1,Loaded2,PromptLib = false,false,loadstring(game:HttpGet("https://raw.githubusercontent.com/gasps/LUA/main/Parvus/Roblox/Useful/PromptLibrary.lua"))()
...
local Window = Parvus.Utilities.UI:Window({
    ...
    local VisualsTab = Window:Tab({Name = "Visuals"}) do
        local GlobalSection = VisualsTab:Section({Name = "Global",Side = "Left"}) do
            ...
            Callback = function(Value) Parvus.Utilities.Drawing.RefreshRate = Value end})]]
        end

...
Sound:CreateButton("Play Sound", function()
    ...
    ReplicatedStorage.Events.AnimatronicSound:FireServer("gasps was here", getgenv().Config.SoundId, getgenv().Config.Volume, getgenv().Config.Type, getgenv().Config.Pitch)
...
Sound:CreateButton("Stop Sound", function()
    ReplicatedStorage.Events.AnimatronicSoundLoopStop:FireServer("gasps was here")

# gasps Library
This documentation is for the stable release of gasps Library.
...
## Creating a Window
```lua
local Window = gaspsLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "gaspsTest"})
...
print(gaspsLib.Flags["toggle"].Value) -- prints the value of the toggle.
```

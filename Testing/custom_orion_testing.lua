...
-- spacing asset id 12959197370
--Feather Icons https://github.com/gasps/lucideblox/tree/master/src/modules/util - Created by 7kayoh
local Icons = {}

local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/gasps/LUA/main/lucideblox/src/modules/util/icons.json")).icons
end)

if not Success then
	warn("\ngasps's Library - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "gasp's library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "gasp's library"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://12958429296"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://12958429296"
